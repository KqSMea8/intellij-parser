...
(function (factory) {
    ...
    (function (SyntaxKind) {
        ...
        SyntaxKind["dropTableStatement"] = "dropTableStatement";
        SyntaxKind["alterStatement"] = "alterStatement";
        ...
        function Parser(input) {
            ...
            _this.RULE('root', function () {
                _this.MANY(function () {
                    ...
                    _this.CONSUME(lexer_g_1.Tokens.SEMICOLON);
                });
            });
            ...
            _this.RULE('ddlStatement', function () {
                _this.OR([
                    ...
                    {
                        ALT: function () {
                            _this.SUBRULE(_this.createTableStatement);
                        },
                    },
                    {
                        ALT: function () {
                            _this.SUBRULE(_this.dropTableStatement);
                        },
                    },
                    {
                        ALT: function () {
                            _this.SUBRULE(_this.alterStatement);
                        },
                    },
                    {
                        ALT: function () {
            ...
            _this.RULE('createTableStatement', function () {
                _this.CONSUME(lexer_g_1.Tokens.KWCREATE);
                _this.OPTION(function () {
            ...
            _this.RULE('dropTableStatement', function () {
                _this.CONSUME(lexer_g_1.Tokens.KWDROP);
                _this.CONSUME(lexer_g_1.Tokens.KWTABLE);
                _this.OPTION(function () {
                    _this.SUBRULE(_this.ifExists);
            ...
            _this.RULE('alterStatement', function () {
            ...
            _this.RULE('joinSource', function () {
                ...
                _this.MANY(function () {
                    ...
                    _this.SUBRULE2(_this.fromSource);
                });
            });
            _this.RULE('joinToken', function () {
                _this.OR([
                    {
                        ALT: function () {
                            _this.CONSUME(lexer_g_1.Tokens.KWJOIN);
                        },
                    },
                    {
                        ALT: function () {
                            _this.CONSUME(lexer_g_1.Tokens.KWINNER);
                            _this.CONSUME2(lexer_g_1.Tokens.KWJOIN);
                        },
                    },
                    {
                        ALT: function () {
                            _this.CONSUME(lexer_g_1.Tokens.KWCROSS);
                            _this.CONSUME3(lexer_g_1.Tokens.KWJOIN);
                        },
                    },
                    {
                        ALT: function () {
                            ...
                            _this.CONSUME4(lexer_g_1.Tokens.KWJOIN);
                        },
                    },
                    {
                        ALT: function () {
                            ...
                            _this.CONSUME5(lexer_g_1.Tokens.KWJOIN);
                        },
                    },
                    {
                        ALT: function () {
                            ...
                            _this.CONSUME6(lexer_g_1.Tokens.KWJOIN);
                        },
                    },
                    {
                        ALT: function () {
                            ...
                            _this.CONSUME7(lexer_g_1.Tokens.KWJOIN);
                        },
                    },
                ]);
            });
