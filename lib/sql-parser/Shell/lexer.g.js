(function (factory) {
    ...
    var CLI_CHMOD_MOD = chevrotain.createToken({
        name: 'CLI_CHMOD_MOD',
        pattern: /[ugoa]*[+\-=][rwxX]+/,
        longer_alt: ID,
    });
    ...
    var PIP = chevrotain.createToken({
        name: 'PIP',
        pattern: /PIP/i,
        longer_alt: ID,
    });
    var PYTHON = chevrotain.createToken({
        name: 'PYTHON',
        pattern: /PYTHON/i,
        longer_alt: ID,
    });
    var DOLLAR_WITH_LEFT_BRACKET = chevrotain.createToken({
    ...
    var DEVIDE = chevrotain.createToken({
        name: 'DEVIDE',
        pattern: /\//i,
        longer_alt: ID,
    });
    var MULTI = chevrotain.createToken({
        name: 'MULTI',
        pattern: /\*/i,
        longer_alt: ID,
    });
    ...
    var CAT = chevrotain.createToken({
        name: 'CAT',
        pattern: /CAT/i,
        longer_alt: ID,
    });
    var CHOWN = chevrotain.createToken({
        name: 'CHOWN',
        pattern: /CHOWN/i,
        longer_alt: ID,
    });
    ...
    var NOT_GREATER_SYMBOL = chevrotain.createToken({
        name: 'NOT_GREATER_SYMBOL',
        pattern: /\-?le/i,
        longer_alt: ID,
    });
    var NOT_GREATER = chevrotain.createToken({
        name: 'NOT_GREATER',
        pattern: /\<\=/i,
        longer_alt: ID,
    });
    var NOT_SMALLER_SYMBOL = chevrotain.createToken({
        name: 'NOT_SMALLER_SYMBOL',
        pattern: /\-?ge/i,
        longer_alt: ID,
    });
    var NOT_SMALLER = chevrotain.createToken({
        name: 'NOT_SMALLER',
        pattern: /\>\=/i,
        longer_alt: ID,
    });
    var SMALLER_SYMBOL = chevrotain.createToken({
        name: 'SMALLER_SYMBOL',
        pattern: /\-?lt/i,
        longer_alt: ID,
    });
    ...
    var NOT_EQUAL_TO_SYMBOL = chevrotain.createToken({
        name: 'NOT_EQUAL_TO_SYMBOL',
        pattern: /\-?ne/i,
        longer_alt: ID,
    });
    var NOT_EQUAL_TO = chevrotain.createToken({
        name: 'NOT_EQUAL_TO',
        pattern: /\!\=/i,
        longer_alt: ID,
    });
    var EQUAL_TO_SYMBOL = chevrotain.createToken({
        name: 'EQUAL_TO_SYMBOL',
        pattern: /\-?eq/i,
        longer_alt: ID,
    });
    var EQUAL_TO = chevrotain.createToken({
        name: 'EQUAL_TO',
        pattern: /\=\=/i,
        longer_alt: ID,
    });
    ...
    var DOUBLE_LEFT_SQUARE_BRACKET = chevrotain.createToken({
        name: 'DOUBLE_LEFT_SQUARE_BRACKET',
        pattern: /\[\[/i,
        longer_alt: ID,
    });
    var DOUBLE_RIGHT_SQUARE_BRACKET = chevrotain.createToken({
    ...
    var ELSE_IF = chevrotain.createToken({
        name: 'ELSE_IF',
        pattern: /ELIF/i,
        longer_alt: ID,
    });
    ...
    (function (TokenEnum) {
        ...
        TokenEnum["CLI_CHMOD_MOD"] = "CLI_CHMOD_MOD";
        TokenEnum["NO_CREATE"] = "NO_CREATE";
        TokenEnum["DIGIT_TO_SEVEN"] = "DIGIT_TO_SEVEN";
        TokenEnum["DIGIT"] = "DIGIT";
        TokenEnum["PIP"] = "PIP";
        TokenEnum["PYTHON"] = "PYTHON";
        TokenEnum["DOLLAR_WITH_LEFT_BRACKET"] = "DOLLAR_WITH_LEFT_BRACKET";
        TokenEnum["COMMENT"] = "COMMENT";
        TokenEnum["ECHO"] = "ECHO";
        TokenEnum["DEVIDE"] = "DEVIDE";
        TokenEnum["MULTI"] = "MULTI";
        TokenEnum["ADD"] = "ADD";
        TokenEnum["SLEEP"] = "SLEEP";
        TokenEnum["EXIT"] = "EXIT";
        TokenEnum["CAT"] = "CAT";
        TokenEnum["CHOWN"] = "CHOWN";
        TokenEnum["CHMOD"] = "CHMOD";
        TokenEnum["TOUCH"] = "TOUCH";
        TokenEnum["COLON"] = "COLON";
        TokenEnum["COMMA"] = "COMMA";
        TokenEnum["NOT_GREATER_SYMBOL"] = "NOT_GREATER_SYMBOL";
        TokenEnum["NOT_GREATER"] = "NOT_GREATER";
        TokenEnum["NOT_SMALLER_SYMBOL"] = "NOT_SMALLER_SYMBOL";
        TokenEnum["NOT_SMALLER"] = "NOT_SMALLER";
        TokenEnum["SMALLER_SYMBOL"] = "SMALLER_SYMBOL";
        TokenEnum["GREATER_SYMBOL"] = "GREATER_SYMBOL";
        TokenEnum["NOT_EQUAL_TO_SYMBOL"] = "NOT_EQUAL_TO_SYMBOL";
        TokenEnum["NOT_EQUAL_TO"] = "NOT_EQUAL_TO";
        TokenEnum["EQUAL_TO_SYMBOL"] = "EQUAL_TO_SYMBOL";
        TokenEnum["EQUAL_TO"] = "EQUAL_TO";
        ...
        TokenEnum["SEMI"] = "SEMI";
        TokenEnum["DOUBLE_LEFT_SQUARE_BRACKET"] = "DOUBLE_LEFT_SQUARE_BRACKET";
        TokenEnum["DOUBLE_RIGHT_SQUARE_BRACKET"] = "DOUBLE_RIGHT_SQUARE_BRACKET";
