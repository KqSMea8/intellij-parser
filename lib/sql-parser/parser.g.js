...
(function (factory) {
    ...
    (function (SyntaxKind) {
        ...
        SyntaxKind["partitionFunctionDefinition"] = "partitionFunctionDefinition";
                ...
                _this.OR([
                    {
                        ALT: function () {
                            _this.OPTION(function () {
                                _this.CONSUME(lexer_g_1.Tokens.LINEAR);
                            });
                    ...
                    },
                    {
                        ALT: function () {
                            _this.OPTION2(function () {
                                _this.CONSUME2(lexer_g_1.Tokens.LINEAR);
                            });
                    ...
                    },
                    {
                        ALT: function () {
                            ...
                            _this.OR4([
                                ...
                                {
                                    ALT: function () {
                                        _this.CONSUME2(lexer_g_1.Tokens.COLUMNS);
