    ...
    var Parser = (function (_super) {
        ...
        function Parser(input) {
            ...
            _this.RULE('fullId', function () {
                ...
                _this.MANY({
                    GATE: function () {
                        if (_this.LA(1).tokenType === lexer_g_1.Tokens.DOT) {
                            throw _this.SAVE_ERROR(new chevrotain.MismatchedTokenException("Expecting token of type --> ID <-- but found ''", _this.LA(1), _this.LA(0)));
                        }
                        return _this.LA(1).tokenType === lexer_g_1.Tokens.DOT_ID || _this.LA(1).tokenType === lexer_g_1.Tokens.DOT;
                    },
                    DEF: function () {
