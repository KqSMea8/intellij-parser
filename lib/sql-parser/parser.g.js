    ...
    var Parser = (function (_super) {
        ...
        function Parser(input) {
            ...
            _this.RULE('insertStatement', function () {
                ...
                _this.OPTION({
                    GATE: function () {
                        if (lexer_g_1.Tokens.INSERT.tokenTypeIdx === _this.LA(0).tokenTypeIdx && _this.LA(1).image === '') {
                            throw _this.SAVE_ERROR(new chevrotain.MismatchedTokenException("Expecting: one of these possible Token sequences: 1.[INTO], 2:[OVERWRITE] <-- but found ''", _this.LA(1), _this.LA(0)));
                        }
                        return lexer_g_1.Tokens.INSERT.tokenTypeIdx === _this.LA(0).tokenTypeIdx;
                    },
                    DEF: function () {
            ...
            _this.RULE('fromClause', function () {
                ...
                _this.OPTION({
                    GATE: function () {
                        if (lexer_g_1.Tokens.ID.tokenTypeIdx === _this.LA(0).tokenTypeIdx && _this.LA(1).image === '') {
                            throw _this.SAVE_ERROR(new chevrotain.MismatchedTokenException("Expecting: one of these possible Token sequences: 1.[WHERE], 2:[GROUP], 3:[HAVING] <-- but found ''", _this.LA(1), _this.LA(0)));
                        }
                        return lexer_g_1.Tokens.ID.tokenTypeIdx === _this.LA(0).tokenTypeIdx;
                    },
                    DEF: function () {
                        _this.CONSUME(lexer_g_1.Tokens.WHERE);
                        _this.SUBRULE(_this.expression);
