                    ...
                    },
                    {
                        ALT: function () {
                            ...
                            _this.OPTION27(function () {
                                _this.CONSUME24(lexer_g_1.Tokens.EQUAL_SYMBOL);
                            });
                ...
                _this.OPTION({
                    GATE: function () {
                        if (lexer_g_1.Tokens.ID.tokenTypeIdx === _this.LA(0).tokenTypeIdx && _this.LA(1).image === '') {
                            throw _this.SAVE_ERROR(new chevrotain.MismatchedTokenException("Expecting token of type --> WHERE <-- but found ''", _this.LA(1), _this.LA(0)));
                        }
