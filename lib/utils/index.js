...
(function (factory) {
    ...
    var peel = function (cst) {
        ...
        var exportsFields = query ? _.flatten(getFilteredNode(query.children[parser_g_1.SyntaxKind.selectElements][0], function (target) { return target.name === parser_g_1.SyntaxKind.selectElements; }, true).map(function (fields) {
