...
function getColorValue(node) {
    if (node.type === nodes.NodeType.HexColorValue) {
        ...
        try {
            ...
            else if (name_1 === 'hsl' || name_1 === 'hsla') {
...
function evalBrowserEntry(browsers) {
    ...
    browserEntry.onCodeComplete = count > 0;
    return browserEntry;
}
    ...
    Object.defineProperty(EntryImpl.prototype, "restrictions", {
        get: function () {
            if (this.data.restriction) {
                return this.data.restriction.split(',').map(function (s) {
                    return s.trim();
                });
            }
            else {
