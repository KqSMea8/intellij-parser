...
var SQLCompletion = (function () {
    function SQLCompletion(variablePrefix) {
        if (variablePrefix === void 0) { variablePrefix = null; }
        this.completionParticipants = [];
        this.valueTypes = [
            nodes.NodeType.Identifier,
            nodes.NodeType.Value,
            nodes.NodeType.StringLiteral,
            nodes.NodeType.URILiteral,
            nodes.NodeType.NumericValue,
            nodes.NodeType.HexColorValue,
            nodes.NodeType.VariableName,
            nodes.NodeType.Prio
        ];
        this.variablePrefix = variablePrefix;
    }
    SQLCompletion.prototype.getSymbolContext = function () {
        if (!this.symbolContext) {
            this.symbolContext = new sqlSymbolScope_1.Symbols(this.styleSheet);
        }
        return this.symbolContext;
    };
    SQLCompletion.prototype.setCompletionParticipants = function (registeredCompletionParticipants) {
        this.completionParticipants = registeredCompletionParticipants || [];
    };
    SQLCompletion.prototype.doComplete = function (document, position, styleSheet) {
    ...
    SQLCompletion.prototype.finalize = function (result) {
    ...
    SQLCompletion.prototype.findInNodePath = function () {
        var types = [];
    ...
    SQLCompletion.prototype.getCompletionsForDeclarationProperty = function (declaration, result) {
        return this.getPropertyProposals(declaration, result);
    };
    SQLCompletion.prototype.getPropertyProposals = function (declaration, result) {
        var _this = this;
    ...
    SQLCompletion.prototype.getCompletionsForDeclarationValue = function (node, result) {
        var _this = this;
    ...
    SQLCompletion.prototype.getValueEnumProposals = function (entry, existingNode, result) {
        if (entry.values) {
    ...
    SQLCompletion.prototype.getCSSWideKeywordProposals = function (entry, existingNode, result) {
    ...
    SQLCompletion.prototype.getCompletionsForInterpolation = function (node, result) {
        if (this.offset >= node.offset + 2) {
            this.getVariableProposals(null, result);
        }
        return result;
    };
    SQLCompletion.prototype.getVariableProposals = function (existingNode, result) {
    ...
    SQLCompletion.prototype.getVariableProposalsForCSSVarFunction = function (result) {
        var symbols = this.getSymbolContext().findSymbolsAtOffset(this.offset, nodes.ReferenceType.Variable);
    ...
    SQLCompletion.prototype.getUnitProposals = function (entry, existingNode, result) {
        var currentWord = '0';
    ...
    SQLCompletion.prototype.getCompletionRange = function (existingNode) {
    ...
    SQLCompletion.prototype.getColorProposals = function (entry, existingNode, result) {
    ...
    SQLCompletion.prototype.getPositionProposals = function (entry, existingNode, result) {
    ...
    SQLCompletion.prototype.getRepeatStyleProposals = function (entry, existingNode, result) {
    ...
    SQLCompletion.prototype.getLineStyleProposals = function (entry, existingNode, result) {
    ...
    SQLCompletion.prototype.getLineWidthProposals = function (entry, existingNode, result) {
    ...
    SQLCompletion.prototype.getGeometryBoxProposals = function (entry, existingNode, result) {
    ...
    SQLCompletion.prototype.getBoxProposals = function (entry, existingNode, result) {
    ...
    SQLCompletion.prototype.getImageProposals = function (entry, existingNode, result) {
    ...
    SQLCompletion.prototype.getTimingFunctionProposals = function (entry, existingNode, result) {
    ...
    SQLCompletion.prototype.getBasicShapeProposals = function (entry, existingNode, result) {
    ...
    SQLCompletion.prototype.getCompletionsForStylesheet = function (result) {
    ...
    SQLCompletion.prototype.getCompletionForTopLevel = function (result) {
    ...
    SQLCompletion.prototype.getCompletionsForRuleSet = function (ruleSet, result) {
    ...
    SQLCompletion.prototype.getCompletionsForSelector = function (ruleSet, isNested, result) {
        var _this = this;
        ...
        if (!existingNode &&
            this.offset - this.currentWord.length > 0 &&
            this.textDocument.getText()[this.offset - this.currentWord.length - 1] === ':') {
    ...
    SQLCompletion.prototype.getCompletionsForDeclarations = function (declarations, result) {
    ...
    SQLCompletion.prototype.getCompletionsForVariableDeclaration = function (declaration, result) {
        if (this.offset > declaration.colonPosition) {
            this.getVariableProposals(declaration.getValue(), result);
        }
        return result;
    };
    SQLCompletion.prototype.getCompletionsForExpression = function (expression, result) {
    ...
    SQLCompletion.prototype.getCompletionsForFunctionArgument = function (arg, func, result) {
    ...
    SQLCompletion.prototype.getCompletionsForFunctionDeclaration = function (decl, result) {
    ...
    SQLCompletion.prototype.getCompletionsForMixinReference = function (ref, result) {
    ...
    SQLCompletion.prototype.getTermProposals = function (entry, existingNode, result) {
    ...
    SQLCompletion.prototype.makeTermProposal = function (symbol, parameters, existingNode) {
    ...
    SQLCompletion.prototype.getCompletionsForSupportsCondition = function (supportsCondition, result) {
        ...
        if (isDefined(supportsCondition.lParent) &&
            this.offset > supportsCondition.lParent &&
            (!isDefined(supportsCondition.rParent) || this.offset <= supportsCondition.rParent)) {
            return this.getCompletionsForDeclarationProperty(null, result);
        }
        return result;
    };
    SQLCompletion.prototype.getCompletionsForSupports = function (supports, result) {
    ...
    SQLCompletion.prototype.getCompletionsForExtendsReference = function (extendsRef, existingNode, result) {
        return result;
    };
    SQLCompletion.prototype.getCompletionForUriLiteralValue = function (uriLiteralNode, result) {
        var uriValue;
        var position;
        var range;
...
exports.SQLCompletion = SQLCompletion;
var Set = (function () {
    function Set() {
        this.entries = {};
    }
...
var ColorValueCollector = (function () {
    ...
    ColorValueCollector.prototype.visitNode = function (node) {
        if (node instanceof nodes.HexColorValue ||
            (node instanceof nodes.Function && languageFacts.isColorConstructor(node))) {
...
//# sourceMappingURL=sqlCompletion.js.map