...
var SQLIssueType = (function () {
    function SQLIssueType(id, message) {
        this.id = id;
        this.message = message;
    }
    return SQLIssueType;
}());
exports.SQLIssueType = SQLIssueType;
exports.ParseError = {
    ...
    RuleOrSelectorExpected: new SQLIssueType('css-ruleorselectorexpected', localize('expected.ruleorselector', 'at-rule or selector expected')),
    ...
    ExpressionExpected: new SQLIssueType('css-expressionexpected', localize('expected.expression', 'expression expected')),
    ...
    PercentageExpected: new SQLIssueType('css-percentageexpected', localize('expected.percentage', 'percentage expected')),
    URIOrStringExpected: new SQLIssueType('css-uriorstringexpected', localize('expected.uriorstring', 'uri or string expected')),
    ...
    VariableValueExpected: new SQLIssueType('css-varvalueexpected', localize('expected.varvalue', 'variable value expected')),
    PropertyValueExpected: new SQLIssueType('css-propertyvalueexpected', localize('expected.propvalue', 'property value expected')),
    ...
    PageDirectiveOrDeclarationExpected: new SQLIssueType('css-pagedirordeclexpected', localize('expected.pagedirordecl', 'page directive or declaraton expected')),
    ...
    StringLiteralExpected: new SQLIssueType('css-stringliteralexpected', localize('expected.stringliteral', 'string literal expected')),
    WhitespaceExpected: new SQLIssueType('css-whitespaceexpected', localize('expected.whitespace', 'whitespace expected')),
    MediaQueryExpected: new SQLIssueType('css-mediaqueryexpected', localize('expected.mediaquery', 'media query expected'))
};
//# sourceMappingURL=sqlErrors.js.map