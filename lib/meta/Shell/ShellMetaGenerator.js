...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../MetaLexer", "lodash", "../MetaParser"], factory);
    }
    ...
    var RulesNode = (function (_super) {
        ...
        RulesNode.prototype.sortRules = function () {
            ...
            var IDPos = _.findIndex(this.rules, { tokenName: 'ID' });
            this.rules = this.rules.slice(0, IDPos).concat(this.rules.slice(IDPos + 1), [this.rules[IDPos]]);
        };
        ...
        RulesNode.prototype.toLexerCode = function () {
            return this.rules
                .filter(function (rule) { return !rule.fragName && rule.tokenName !== 'STRING_LITERAL' && rule.tokenName !== 'ID' && rule.tokenName !== 'DIGIT' && rule.tokenName !== 'DIGIT_TO_SEVEN'; })
                .map(function (rule) { return rule.toLexerCode(); })
                .join('\n');
        };
    ...
    var RuleNode = (function (_super) {
        ...
        RuleNode.prototype.setPattern = function () {
            if (this.atoms.length > 1) {
                this.pattern = '(' + this.atoms.map(function (atom) { return atom.toLexerCode(); }).join('|') + ')';
            }
            else {
    ...
    var AtomNode = (function (_super) {
        ...
        AtomNode.prototype.toLexerCode = function () {
            return this.itemSuffs.map(function (itemSuff) { return itemSuff.toLexerCode(); }).join('');
        };
    ...
    var ItemSuffNode = (function (_super) {
        ...
        ItemSuffNode.prototype.toLexerCode = function () {
            var itemLexer = this.item.toLexerCode();
            if (this.hasNot) {
    ...
    var BracketExpNode = (function (_super) {
        ...
        BracketExpNode.prototype.toLexerCode = function () {
            if (this.atoms.length) {
                return "(" + this.atoms.map(function (atom) { return atom.toLexerCode(); }).join('|') + ")";
            }
    ...
    var AllNode = (function (_super) {
        ...
        AllNode.prototype.toLexerCode = function () {
            return '.';
        };
        return AllNode;
    }(BaseNode));
...
//# sourceMappingURL=ShellMetaGenerator.js.map