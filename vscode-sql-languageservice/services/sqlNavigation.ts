...
import { Symbols } from '../parser/sqlSymbolScope';
import { getColorValue, hslFromColor } from '../services/languageFacts';

import * as nls from 'vscode-nls';
import { ColorInformation, ColorPresentation, Color } from '../sqlLanguageService';
import { FoldingRangeList } from '../protocol/foldingProvider.proposed';
import { getFoldingRegions } from './sqlFolding';

const localize = nls.loadMessageBundle();

export class SQLNavigation {
  ...
  public getColorPresentations(
    ...
    let red256 = Math.round(color.red * 255),
